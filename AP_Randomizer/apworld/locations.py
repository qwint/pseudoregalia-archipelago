...
location_table = {
    ...
    "Castle Sansa - Memento Goatling": PseudoregaliaLocationData(
        code=2365810072,
        region="Castle Main",
        can_create=lambda options: options.goatsanity and options.game_version == MAP_PATCH,
    ),
    ...
    "Listless Library - A Book About a Princess": PseudoregaliaLocationData(
        code=2365810098,
        region="Library Main",
        can_create=lambda options: bool(options.booksanity),
    ),
    ...
    "Listless Library - Note Near Eggs": PseudoregaliaLocationData(
        code=2365810111,
        region="Library Top",
        can_create=lambda options: bool(options.notesanity),
    ),
